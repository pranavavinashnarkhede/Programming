// Write java program to accept directory name from user and write data of all files along with its name & size 
// of each file into one newly created file named as “Marvellous.txt”.
       ...
       if(fobj.exists() && fobj.isDirectory())
       {
            ...
            for(int i = 0 ; i < arr.length ; i++)
            {
                ...
                if(arr[i].isFile())
                {
                    ...
                    String size = String.valueOf(lLength);
